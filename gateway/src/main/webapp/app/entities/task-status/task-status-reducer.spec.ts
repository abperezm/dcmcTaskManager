...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TASKSTATUS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TASKSTATUS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TASKSTATUS actions', async () => {
      const arg = { id: 17535 };
    ...
    it('dispatches UPDATE_TASKSTATUS actions', async () => {
      const arg = { id: 17535 };
    ...
    it('dispatches PARTIAL_UPDATE_TASKSTATUS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TASKSTATUS actions', async () => {
      const arg = 42666;
