...
import reducer, {
  ...
  reset,
  updateEntity,
} from './work-group-membership.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WORKGROUPMEMBERSHIP_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_WORKGROUPMEMBERSHIP actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_WORKGROUPMEMBERSHIP actions', async () => {
      const arg = { id: 19256 };
    ...
    it('dispatches UPDATE_WORKGROUPMEMBERSHIP actions', async () => {
      const arg = { id: 19256 };
    ...
    it('dispatches PARTIAL_UPDATE_WORKGROUPMEMBERSHIP actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_WORKGROUPMEMBERSHIP actions', async () => {
      const arg = 42666;
